...
config :bamboo_gmail_smtp, BambooGmailSmtp.Mailer,
  ...
  hostname: System.get_env("SMTP_HOST_NAME"),
  port: System.get_env("GMAIL_SMTP_PORT"),
  username: System.get_env("GMAIL_SMTP_USER"), # or {:system, "SMTP_USERNAME"}
  password: System.get_env("GMAIL_SMTP_PASSWORD"), # or {:system, "SMTP_PASSWORD"}
